...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cosmix-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13297&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cosmix-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cosmix` can be installed with:

```
conda install cosmix
```

It is possible to list all of the versions of `cosmix` available on your platform with:
